...
exports.convertToLowcode = convertToLowcode;
...
function convertToLowcode(input, options) {
    var lowcodeOptions = Object.create(options || {});
    lowcodeOptions.outputFormat = "lowcode";
    return convert(input, lowcodeOptions);
}
    ...
    return documentResult.flatMapThen(function(document) {
        return styleMapResult.flatMapThen(function(styleMap) {
            if (options.outputFormat === "lowcode") {
                return documentConverter.convertToLowcode(document);
            } else {
