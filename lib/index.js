...
function convertDocumentToLowcodeSchema(documentResult, options) {
    var styleMapResult = parseStyleMap(options.readStyleMap());
    var parsedOptions = _.extend({}, options, {
        styleMap: styleMapResult.value
    });
    ...
    return documentResult.flatMapThen(function(document) {
        return styleMapResult.flatMapThen(function(styleMap) {
            return documentConverter.convertToLowcodeSchema(document);
        });
    });
}

function convertToLowcodeSchema(input, options) {
    options = readOptions(options);
    ...
    return unzip.openZip(input)
        ...
        .then(function(docxFile) {
            return docxReader.read(docxFile, input, options)
                ...
                .then(function(documentResult) {
                    return convertDocumentToLowcodeSchema(documentResult, options);
                });
        });
}
